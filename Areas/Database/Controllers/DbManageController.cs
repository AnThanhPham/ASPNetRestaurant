...
namespace ManagingRestaurant.Areas.Database.Controllers
{
    [Area("Database")]
    ...
    public class DbManageController : Controller
    {
        ...
        public DbManageController(RestaurantContext dbContext, UserManager<AppUser> userManager, RoleManager<IdentityRole> roleManager)
        {
